...
select * from (values
  ...
  ('all', 90, '⏳', 'Go-backs & come-backs',
    ...
    'A go-back is an inspection go-back — a roof that came back Retail, Damage, or No-Damage and the homeowner gave you the best time to return. It''s NOT a locked appointment, just their best time. Set a best time and the map routes you to be in that area around then; leave it blank and it weaves into your day wherever it fits. On the right day it''s a required stop on Start my day — you never keep a list.\n\nAn appointment is different: a firm SET time, like a back-to-retail "come back tomorrow at noon." Appointments always come first; go-backs route around them.'),
  ('all', 100, '⭐', 'Referral',
