...
select * from (values
  ...
  ('all', 40, '📅', 'Plan your day (around appointments)',
    ...
    'Tap ▶ Start my day (it opens Plan-your-day) and enter your start time. It drops each appointment in at its time and fills the gaps with doors, keeping you close so you''re never late — to 8 PM. Any go-backs due today are pulled in as required stops, so appointments, go-backs, and fresh doors are one route.\n\nWhen you finish an appointment, tell it how it went (same for IQ / FB / AI / BTR appts):\n🔄 Rescheduled — you re-booked them; it resets the appointment in JobNimbus.\n🔴 No sit – needs to reschedule — they didn''t sit and you couldn''t re-book; it moves them onto your reschedule list.\n✅ Appt done — you sat them (sold or no-sale); that syncs back from JobNimbus.\nWhichever you tap, it re-plans the rest of your day off the real clock.'),
  ...
  ('all', 90, '⏳', 'Go-backs & come-backs',
    ...
    'A go-back is an inspection go-back — after you SIGN a homeowner up, you ask their typical availability (e.g. Tues & Wed at 5). That''s a tentative come-back to go over their inspection results: Retail, Damage, or No-Damage.\n\nIt''s NOT a locked appointment — just their best/typical time. Set it and the map routes you to be in that area around then; leave it blank and it weaves into your day. On that day it''s a required stop on Start my day — you never keep a list.\n\nWhen you arrive, the card gives you the action for that type:\n🏠 Retail — schedule a retail appointment, or record Sit Sold / Sit No Sale.\n🏚️ Damage — schedule the Public Adjuster (pick an open time).\n✅ No-Damage — collect referrals.\n\nAn appointment is different: if a homeowner''s interested but not signed and locks in a firm time (you offer a 2 or a 5, they pick 5), tap ⏳ Pending (come back) and set it — that''s an appointment. Appointments always come first; go-backs route around them.'),
  ('all', 100, '⭐', 'Referral',
