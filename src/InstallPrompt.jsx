  ...
  return (
    <div style={{ position: "fixed", left: 12, right: 12, bottom: 12, zIndex: 100000, display: "flex", justifyContent: "center", pointerEvents: "none" }}>
      <div style={{ pointerEvents: "auto", background: "#13294b", color: "#fff", borderRadius: 14, boxShadow: "0 6px 24px rgba(0,0,0,.35)", padding: "12px 14px", width: "min(440px, 100%)", boxSizing: "border-box" }}>
        {iosHelp ? (
          <div>
            <div style={{ fontFamily: OSWALD, fontWeight: 800, fontSize: 15, marginBottom: 6 }}>📲 Add to your Home Screen</div>
            <ol style={{ margin: "0 0 10px 18px", padding: 0, fontSize: 13.5, lineHeight: 1.6 }}>
            ...
            <button type="button" onClick={dismiss} style={{ width: "100%", background: "rgba(255,255,255,.15)", color: "#fff", border: "none", borderRadius: 10, padding: "9px", fontSize: 13, fontWeight: 700, cursor: "pointer" }}>Got it</button>
          </div>
        ) : (
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 12, opacity: 0.85, marginTop: 1 }}>Add it to your {isIOS() ? "home screen" : "phone or desktop"} — opens right to your tools.</div>
            </div>
            <button type="button" onClick={install} style={{ flexShrink: 0, background: "#16a34a", color: "#fff", border: "none", borderRadius: 10, padding: "9px 14px", fontSize: 13.5, fontWeight: 800, fontFamily: OSWALD, cursor: "pointer" }}>
              {isIOS() ? "How?" : "Install"}
            </button>
