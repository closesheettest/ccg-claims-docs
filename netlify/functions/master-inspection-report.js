...
export const handler = async (event) => {
  ...
  try {
    ...
    const RB = { ni: "BTR – Not Interested", btr_appt: "BTR – Appointment", retail_appt: "Retail – Appointment", sold: "BTR Sold", credit_denial: "BTR – Credit Denial", no_sale: "BTR – No Sale", pending: "Not worked yet (rep hasn't gone back)" };
    const buckets = { ni: 0, btr_appt: 0, retail_appt: 0, sold: 0, credit_denial: 0, no_sale: 0, pending: 0 };
