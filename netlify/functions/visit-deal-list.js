...
exports.handler = async (event) => {
  ...
  try {
    const sel = "id,client_name,address,city,state,zip,mobile,email,jn_job_id,latitude,longitude,result,result_at,pa_id";
    ...
    const deals = rows.map((r) => {
      ...
      return {
        ...
        distance_mi: dist, result: r.result, result_at: r.result_at, pa_id: r.pa_id,
      };
    });
