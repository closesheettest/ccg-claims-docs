// netlify/functions/sync-retail-status.js  (callable WORKER; the scheduled
// cron-sync-retail-status wrapper calls this, and the office can trigger it on demand)
//
